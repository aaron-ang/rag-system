"""
Evaluation script for the SciNCL-based Medical RAG System
...
def evaluate_scincl_rag_system(rag_system: SciNCLMedicalRAG, k=10):
    """
    Evaluates the SciNCL RAG system on a test set of queries.
    """
    # Load test queries
    ...
    print("\n" + "=" * 60)
    print("SciNCL Medical RAG System - Test Set Evaluation")
    print("=" * 60)
...
if __name__ == "__main__":
    print("🏥 SciNCL Medical RAG System Evaluation")
    print("=" * 50)
    
    # Initialize the RAG system
    print("🔄 Initializing SciNCL RAG system...")
    try:
        rag = SciNCLMedicalRAG()
        print("✅ SciNCL RAG system initialized successfully")
    except Exception as e:
        print(f"❌ Failed to initialize SciNCL RAG system: {e}")
        print("Make sure Qdrant is running and the system is set up.")
        sys.exit(1)
    
    # Run evaluation
    evaluate_scincl_rag_system(rag)
