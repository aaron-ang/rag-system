"""
RAG System with persistence - saves and loads the fitted vectorizer
"""
...
class PersistentMedicalRAG:
    """RAG system with persistence for the fitted vectorizer."""
...
def main():
    ...
    print("🚀 Initializing Persistent Medical RAG System...")
