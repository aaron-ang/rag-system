"""
Setup script for the Qdrant-based Medical RAG System.
...
def setup_environment():
    ...
    if not os.path.exists(env_file):
        ...
        print(
            "✅ Created .env file. Please add your OpenAI API key if you want AI-generated answers."
        )
    else:
...
def main():
    """Main setup function."""
    print("🏥 Medical RAG System Setup (Qdrant Backend)")
    print("=" * 60)
    ...
    print("\nNext steps:")
    print(
        "1. Run: python -m qdrant.sentence_transformer  # Process data with SentenceTransformer"
    )
    print("   OR")
    print("   Run: python -m qdrant.tfidf  # Process data with TF-IDF baseline")
    print("\n2. Run: python -m qdrant.cli  # Start interactive query interface")
    print("   OR")
    print("   Run: python -m qdrant.cli --backend tfidf  # Use TF-IDF backend")
    print("\nOptional:")
