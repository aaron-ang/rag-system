"""
Test script for the Persistent Medical RAG System
"""
...
def main():
    """Test the persistent RAG system with sample queries."""
    ...
    if 'error' in info:
        ...
        print("Please run the main setup first: python rag_with_persistence.py")
        return
